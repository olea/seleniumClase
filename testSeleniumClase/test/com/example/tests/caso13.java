...
public class CambioContraseAIncorrecto2 {
  ...
  @Test
  public void testCambioContraseAIncorrecto2() throws Exception {
    ...
    assertEquals("Password confirmation doesn't match Password", driver.findElement(By.cssSelector("#error_explanation > ul > li")).getText());
