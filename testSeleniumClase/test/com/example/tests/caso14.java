...
public class caso14 {
  ...
  @Test
  public void testCambioDeContraseADeUsuarioOlea() throws Exception {
    ...
    // ahora toca probar a cambiar contraseña equivocada
    driver.findElement(By.linkText("Olea")).click();
    driver.findElement(By.id("user_password")).clear();
    driver.findElement(By.id("user_password")).sendKeys("1111");
    driver.findElement(By.id("user_password_confirmation")).clear();
    driver.findElement(By.id("user_password_confirmation")).sendKeys("1111");
    driver.findElement(By.name("commit")).click();
    assertEquals("Users Admin | Hmislogin", driver.getTitle());
    assertEquals("olea updated.", driver.findElement(By.id("flash_notice")).getText());
